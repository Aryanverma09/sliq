...
const DiscountedProducts = () => {
  ...
  // Get first 4 products or filter by discount if we had that data consistent. 
  // For now taking first 4 for display.
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#fdf2f2] py-20 rounded-[3rem]">
      <div className="flex items-center justify-between mb-12">
        ...
        <Link to="/shop" className="hidden sm:flex items-center gap-2 bg-primary-dark text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-opacity-90 transition-colors">
              ...
              <div className="space-y-1">
                 ...
                 <div className="flex items-end justify-between">
                    ...
                    <button 
                        ...
                        className="bg-primary-dark text-primary-light p-2.5 rounded-full hover:bg-opacity-90 transition-colors"
                    >
      ...
      <div className="mt-8 flex justify-center sm:hidden">
         <Link to="/shop" className="flex items-center justify-center gap-2 bg-primary-dark text-white px-6 py-3 rounded-full text-sm font-medium">
           Open Store <ShoppingCart size={16} />
        </Link>
      </div>
    </section>
